...
type PillColor = 'mint' | 'blue' | 'orange'
...
const GRID_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    readTime: '9 min read',
    date: 'Mar 2025',
    icon: <BarChart2 size={28} strokeWidth={1.4} />,
  },
]
...
const TOPICS = [
  'All', 'GPU', '1440p', 'PC Building', 'Valorant',
  'CS2', 'Elden Ring', 'Game Pass', 'Benchmarks',
  'Tier Lists', 'Reviews', 'Sensitivity',
]
...
function CatPill({ label, color }: ArticleCategory) {
  return (
    <span
      className={cn(
        'rounded-[20px] border px-[9px] py-[2px] text-[10px] font-medium',
        pillStyles[color],
      )}
    >
      {label}
      ...
      <div className="px-4 sm:px-6">
        <div className="mx-auto grid max-w-[860px] grid-cols-1 items-start gap-5 py-5 lg:grid-cols-[1fr_200px]">
          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col justify-between p-[18px]">
                <div>
                  ...
                  <h2 className="mb-2 text-[15px] font-medium leading-[1.35] text-[var(--t1)] transition-colors group-hover:text-[var(--mint)]">
                    {FEATURED.title}
                  </h2>
                  <p className="mb-3 text-[12px] leading-[1.6] text-[var(--t2)]">
                    {FEATURED.excerpt}
                  </p>
                </div>
                <div className="flex flex-wrap items-center gap-2 text-[11px] text-[var(--t3)]">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      viewMode === 'grid'
                        ...
                        : 'bg-[var(--bg2)] text-[var(--t3)] hover:text-[var(--t2)]',
                    )}
                  >
                    <LayoutGrid size={13} />
                  </button>
                  ...
                  {GRID_ARTICLES.map(article => (
                    ...
                    >
                      <div className="relative flex h-[90px] items-center justify-center border-b border-[var(--border)] bg-[var(--bg3)]">
                        ...
                        <div className="absolute bottom-[7px] left-[9px] flex gap-[5px]">
                  ...
                  {LIST_ARTICLES.map(article => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mb-[6px] text-[11px] leading-[1.5] text-[var(--t3)]">
                          {article.excerpt}
                        </p>
                        <div className="flex items-center gap-[5px] text-[10px] text-[var(--t3)]">
                          {article.readTime}
            ...
            {/* List view (all articles as rows) */}
            {viewMode === 'list' && (
              <div className="mb-3 flex flex-col gap-2">
            ...
            <div className="flex items-center justify-center gap-1 py-2">
              <button className="flex h-[30px] w-[30px] items-center justify-center rounded-[7px] border border-[var(--border2)] bg-[var(--bg2)] text-[var(--t2)] hover:text-[var(--t1)]">
                <ChevronLeft size={14} />
              </button>
              {[1, 2, 3].map(p => (
                <button
              ...
              <button className="flex h-[30px] w-[30px] items-center justify-center rounded-[7px] border border-[var(--border2)] bg-[var(--bg2)] text-[12px] text-[var(--t2)] hover:text-[var(--t1)]">
                8
              </button>
              <button className="flex h-[30px] w-[30px] items-center justify-center rounded-[7px] border border-[var(--border2)] bg-[var(--bg2)] text-[var(--t2)] hover:text-[var(--t1)]">
            ...
            <div className="mb-3 overflow-hidden rounded-[10px] border border-[var(--border)] bg-[var(--bg2)]">
              ...
              {TRENDING.map((item, i) => (
                <Link
                  key={item.slug}
                  href={`/blog/${item.slug}`}
                  className="group flex items-center gap-[9px] border-b border-[var(--border)] px-[14px] py-[8px] transition-colors last:border-0 hover:bg-[var(--bg3)]"
                >
